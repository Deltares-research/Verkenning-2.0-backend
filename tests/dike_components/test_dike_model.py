...
def test_dike_model_cost_computation_with_ground_only(gdf_ground):
    ...
    np.testing.assert_allclose(sum(values), 68294.29, rtol=1e-2)
    ...
    np.testing.assert_allclose(cost_dict['Bouwkosten']['Directe Bouwkosten']['Directe kosten grondwerk']['totale_BDBK_grondwerk']['value_incl_BTW'], 82636.09, rtol=1e-2)
